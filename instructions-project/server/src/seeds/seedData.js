...
const projectsSeed = [
  ...
  },
  {
    ...
    clientName: 'Hotel Marquês de Pombal',
    location: 'Lisbon Marquês de Pombal',
    projectType: 'logo',
    status: 'cancelled',
  ...
  },
  {
    ...
    clientName: 'Centro Comercial Colombo',
    location: 'Lisbon Benfica',
    projectType: 'decor',
    status: 'in_queue',
    baseImageUrl: '/demo-images/buildings/shopping-center.jpg',
    startDate: new Date('2025-01-20'),
    endDate: new Date('2025-03-15'),
    budget: 32000,
    description: 'Large-scale Christmas installation for main entrance - waiting for approval from management',
    isFavorite: true,
  },
];
